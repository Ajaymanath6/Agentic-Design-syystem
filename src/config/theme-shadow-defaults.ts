...
export const SHADOW_DEFAULTS = {
  ...
  'border-inset-secondary-press': "inset 0 0 0 1.5px #0A0A0A, inset 3px 3px 10px 0px rgba(26, 26, 26, 0.33)",
  ...
  'confirm-password-valid': "0 0 0 2px rgb(var(--color-brandcolor-primary) / 0.28), 0 0 14px 6px rgb(var(--color-brandcolor-primary) / 0.18), 0 8px 28px rgb(var(--color-brandcolor-primary) / 0.22)",
  'button-brand-glow': "0 10px 36px -6px rgb(var(--color-brandcolor-primary) / 0.5), 0 6px 24px -4px rgb(var(--color-brandcolor-primary) / 0.38), 0 3px 14px -2px rgb(var(--color-brandcolor-primary) / 0.28)",
